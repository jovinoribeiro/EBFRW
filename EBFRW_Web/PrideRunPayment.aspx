<%@ Page Title="" Language="C#"  AutoEventWireup="true" CodeBehind="PrideRunPayment.aspx.cs" Inherits="EBFRW_Web.PrideRunPayment" %>
...
<head id="Head1" runat="server">
   ...
   <link href="Styles/prideregistration.css" rel="Stylesheet" type="text/css" />
    ...
    function printme()
    {
        document.paypal.item_name.value = "2012 EBFRW " + '<%= Session["categorychoice"] %>' + " - " + '<%= Session["genderchoice"] %>';
        //document.paypal.item_name_2.value = "Donation";
        document.paypal.item_number.value = "RegNum:" + '<%= Session["registration_number"] %>';
        document.paypal.amount.value = "$20.00";
        var don = '<%= Session["donationAmount"] %>';
        if (don != null && don != undefined && don.value != "0.00") {
            document.paypal.amount.value = parseFloat(don) + 20.00;
        }
        //alert(document.paypal.amount.value);
        //document.paypal.amount_2.value = '<%= Session["donationAmount"] %>';

        document.paypal.first_name.value = '<%= Session["runnerfirstname"] %>';
        document.paypal.last_name.value = '<%= Session["runnerlastname"] %>';
        document.paypal.email.value = '<%= Session["email"] %>';    
        ...
        document.paypal.on0.value = "DOB:" + '<%= Session["birthday"] %>' + ":" + '<%= Session["runnerfirstname"] %>' +
                    ":" + '<%= Session["runnerlastname"] %>';
        //return false;
        return true;
    }
...
<body>
      ...
      <asp:Table ID="paymentStepTable" runat="server"  BorderWidth="1px" BorderColor="#443266"
        GridLines="Both" HorizontalAlign="Center" Width="950px" >
         <asp:TableRow><asp:TableCell ColumnSpan="3"  Font-Size="2.9em" ForeColor="White"
            HorizontalAlign="Center" VerticalAlign="Middle" Text=" 2012 EBFRW PRIDE RUN AND WALK<br> REGISTRATION" CssClass="ebsignup"></asp:TableCell>
            </asp:TableRow>
        </asp:Table>
        <asp:Table runat="server" borderwidth="1px"  Width="950px" HorizontalAlign="Center" BackColor="#EFF3FB" BorderColor="#443266">
         <asp:TableRow><asp:TableCell ColumnSpan="3"><h3><center>Thank you for your registration!</center></h3></asp:TableCell></asp:TableRow>
         
         <asp:TableRow>
            <asp:TableCell ColumnSpan="3"><p class="pj">Please, keep this confirmation number in your records: <b><asp:Label  Font-Size="Large" runat="server" ID="registrationLabel"></asp:Label></b></p></asp:TableCell>
         </asp:TableRow>

         <asp:TableRow>
            <asp:TableCell ColumnSpan="3"><p class="pj">Your registration has been submitted and will remain in "Pending" status until confirmation of payment. <br />
         ...
         <asp:TableRow>
            ...
            <asp:TableCell HorizontalAlign="Center" BorderWidth="0px" Width="45%"><h3>Check</h3></asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
    ...
    <img alt="" border="0" src="https://www.paypalobjects.com/WEBSCR-640-20110429-1/en_US/i/scr/pixel.gif" width="1" height="1">
            ...
            <asp:TableCell HorizontalAlign="Center" BorderWidth="0px" Visible="false">Checks must be brought on the day of the race</asp:TableCell>
            <asp:TableCell HorizontalAlign="Center" BorderWidth="0px">
             Mail your registration payment to the following address:<br />
                East Bay Front Runners - P.O. Box 71722 - Oakland - CA - 94612                   
            <br /><br />
                Alternatively, you can also hand in your registration payment (check/cash) to any of our officers during one of our 
                Saturday runs.
            </asp:TableCell>
        </asp:TableRow>
      </asp:Table>
